...
class DenseNet(nn.Module):
    def __init__(self, block, nblocks, growth_rate=12, reduction=0.5, num_classes=100):
        ...
        self.featuresadd_modulebn = nn.BatchNorm2d(inner_channels)
        self.featuresadd_modulerelu = nn.ReLU(inplace=True)
    ...
    def forward(self, x):
        ...
        output = self.featuresadd_modulebn(output_features)
        output = self.featuresadd_modulerelu(output)
